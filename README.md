...
Using conditional formatting, I filled each cell in the "state" column with a different color to indicate whether the associated campaign was "successful," "failed," "cancelled," or is currently "live".

Next, I created a new column called "precent funded" to show how much money a campaign made towards reaching its initial goal. This column also has conditional formatting varying from red to green to blue, based on if the campaign hit 0%, 100%, or 200% of its funding goal.
